...
- 📁 **Folders** — file notes into folders (More ▾ → Move to folder, or drag a card onto one); click a folder in the sidebar to filter; new notes land in the folder you're browsing
